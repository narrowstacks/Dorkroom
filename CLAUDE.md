...
- When adding new features to a view, make sure separate any components and hooks you want to make into separate, maintainable files to prevent files in the /(apps)/ directory from being too long.
